...
from langbridge.connectors.base.connector import ApiConnector, QueryResult
...
class ApiConnectorRemoteSource(RemoteSource):
    ...
    async def execute(self, subplan: SourceSubplan) -> RemoteExecutionResult:
        ...
        result = await self._connector.extract_resource(
            resource_name=subplan.resource # type: ignore
        )
