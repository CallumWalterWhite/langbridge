...
0. Read `AGENTS.md` and `.specify/memory/project-guidance.md` before drafting the spec so the runtime/cloud boundary and repo-specific module map are reflected explicitly.
