...
produce a SINGLE deterministic Postgres SQL query that sqlglot can parse. Output ONLY SQL in a fenced code block.
Rules:
...
def build_prompt(model: SemanticModel, user_request: str, dialect: str | None = None) -> str:
