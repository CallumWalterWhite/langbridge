...
export default function DataConnectionsIndex(): JSX.Element {
  ...
  const connectorsQuery = useQuery<ConnectorResponse[]>({
    queryKey: connectorsQueryKey(selectedOrganizationId),
    queryFn: () =>
      fetchConnectors(selectedOrganizationId ?? ''),
