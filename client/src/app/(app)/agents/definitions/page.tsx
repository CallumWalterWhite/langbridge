...
const definitionsQueryKey = ['agent-definitions'] as const;
const connectionsQueryKey = ['llm-connections'] as const;

export default function AgentDefinitionsPage(): JSX.Element {
      ...
      <header className="surface-panel rounded-3xl p-6 shadow-soft">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-end">
            <Button onClick={() => router.push('/agents/definitions/create')} size="sm" className="gap-2">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-3 text-xs text-[color:var(--text-muted)]">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => router.push(`/agents/definitions/${agent.id}`)}
                        className="gap-2"
                      >
