...
export default function AgentsPage({ params }: LLMCreatePageProps): JSX.Element {
  ...
  }, [routeOrganizationId, activeOrganizationId, setSelectedOrganizationId]);
  ...
  function validateForm(): string | null {
    ...
    if (!formState.organizationId.trim() && !formState.projectId.trim() && !routeOrganizationId) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (routeOrganizationId) {
      payload.organizationId = routeOrganizationId;
    } else if (formState.organizationId.trim()) {
    ...
    try {
      setSubmitting(true);
      const connection = await createLLMConnection(routeOrganizationId, payload);
