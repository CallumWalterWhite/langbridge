...
export default function SemanticModelsIndex(): JSX.Element {
  ...
  const semanticModelsQuery = useQuery<SemanticModelRecord[]>({
    queryKey: semanticModelsQueryKey(selectedOrganizationId, selectedProjectId),
    queryFn: () =>
  ...
  const handleCreate = () => {
    router.push('/semantic-model/create');
  };
