...
export default function UnifiedSemanticModelPage(): JSX.Element {
  ...
  }, [selectedOrganizationId, loadConnectors, loadSemanticModels]);
  ...
  return (
    <div className="space-y-6 text-[color:var(--text-secondary)]">
      ...
      {!selectedOrganizationId && !scopeLoading ? (
